                                ...
                                <p class="card-text">
                                    ...
                                    <div class="input-group mb-2">
                                        <input type="text" class="form-control" id="storeUrl" 
                                            value="<?php echo (!empty($store['slug']) ? 
                                                'http://' . $_SERVER['HTTP_HOST'] . '/customer/store-page.php?store=' . $store['slug'] : 
                                                'http://' . $_SERVER['HTTP_HOST'] . '/customer/store-page.php?id=' . $store_id); ?>" 
                                            readonly>
                                    ...
                                    <div class="d-grid gap-2 mb-2">
                                        <button class="btn btn-outline-secondary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#editUrlModal">
                                            <i class="bi bi-pencil"></i> تعديل الرابط
                                        </button>
                                    </div>
                                    <div class="d-grid gap-2">
                                        <a href="../customer/store-page.php?id=<?php echo $store_id; ?>" target="_blank" class="btn btn-primary btn-sm">
                                            <i class="bi bi-shop"></i> عرض صفحة المتجر
                                        </a>
                                    </div>
                                </p>
                            </div>
