...
// جلب العروض مع معلومات إضافية
$offers_sql = "SELECT o.*, 
               COUNT(DISTINCT p.id) as products_count,
               CASE 
                  WHEN o.end_date < CURDATE() THEN 'منتهي'
                  WHEN o.start_date > CURDATE() THEN 'قادم'
                  ELSE 'جاري'
               END as offer_status,
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="add-offers.php" class="btn btn-dashboard-primary">
                        <i class="bi bi-plus-lg me-1"></i> إضافة عرض جديد
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="offer-card">
                            <div class="offer-card-header">
                                ...
                                <div class="offer-discount">
                                    <?php echo $offer['discount_percentage']; ?>% خصم
                                </div>
                                ...
                                if ($offer['offer_status'] == 'جاري') {
                                    $status_class = 'active';
                                    $status_text = 'نشط';
                                } elseif ($offer['offer_status'] == 'قادم') {
                            ...
                            <div class="offer-card-body">
                                ...
                                <?php if ($offer['offer_status'] == 'جاري' && $offer['days_remaining'] > 0): ?>
                                    ...
                                    <div class="text-end mt-1">
                                        <small class="text-muted">متبقي <?php echo $offer['days_remaining']; ?> يوم</small>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="offer-card-footer">
                                <div class="offer-products">
                                    <i class="bi bi-box"></i>
                                    <?php echo $offer['products_count']; ?> منتج
                                </div>
                                
                                <div class="offer-actions">
                                    <a href="edit-offer.php?id=<?php echo $offer['id']; ?>" class="btn btn-edit" title="تعديل">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <button type="button" class="btn btn-delete" title="حذف" onclick="confirmDelete(<?php echo $offer['id']; ?>)">
                    ...
                    <div class="dashboard-card">
                        <div class="card-body">
                            <div class="empty-state">
                                ...
                                <p>لم تقم بإضافة أي عروض بعد. أضف عرضاً جديداً لجذب المزيد من العملاء.</p>
                                <a href="add-offers.php" class="btn btn-dashboard-primary">
                                    <i class="bi bi-plus-lg me-1"></i> إضافة عرض جديد
                                </a>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteOfferModalLabel">تأكيد الحذف</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="إغلاق"></button>
                </div>
                <div class="modal-body">
                    <p>هل أنت متأكد من رغبتك في حذف هذا العرض؟</p>
                    <p class="text-danger">تحذير: سيتم حذف العرض نهائياً ولا يمكن التراجع عن هذا الإجراء.</p>
                </div>
