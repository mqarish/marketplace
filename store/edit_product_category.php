...
$check_sql = "SELECT * FROM product_categories WHERE id = ? AND store_id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_category'])) {
    ...
    if (empty($name)) {
        ...
        if (empty($error_message)) {
            ...
            $sql = "UPDATE product_categories SET name = ?, description = ?, image_url = ? WHERE id = ? AND store_id = ?";
...
$products_sql = "SELECT id, name, price, image_url FROM products WHERE category_id = ? AND store_id = ?";
$products_stmt = $conn->prepare($products_sql);
$products_stmt->bind_param("ii", $category_id, $store_id);
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="product_categories.php" class="btn btn-outline-secondary">
                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="product_categories.php" class="btn btn-outline-secondary ms-2">إلغاء</a>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="related-products">
                    <h4 class="mb-3">المنتجات في هذا التصنيف</h4>
                                ...
                                <div class="col-6 col-md-3 col-lg-2 mb-3">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card-body">
                                            <h6 class="product-card-title" title="<?php echo htmlspecialchars($product['name']); ?>">
