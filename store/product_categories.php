...
// التحقق من وجود جدول تصنيفات المنتجات
$table_exists = $conn->query("SHOW TABLES LIKE 'product_categories'")->num_rows > 0;

// إنشاء جدول تصنيفات المنتجات إذا لم يكن موجوداً
if (!$table_exists) {
    $create_table_sql = "
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_category'])) {
    ...
    if (empty($name)) {
        ...
        if (empty($error_message)) {
            // إدخال التصنيف في قاعدة البيانات
            if (!empty($image_path)) {
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($check_result->num_rows > 0) {
        // تحديث المنتجات المرتبطة بهذا التصنيف
...
<head>
    ...
    <title>تصنيفات المنتجات - لوحة التحكم</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0">تصنيفات المنتجات</h2>
                                ...
                                <div class="category-card">
                                    ...
                                    <div class="category-card-footer">
                                        <div class="category-card-count">
                                            <i class="bi bi-box me-1"></i> <?php echo $category['product_count']; ?> منتج
                                        </div>
                                        <div class="category-card-actions">
                                            <a href="edit_product_category.php?id=<?php echo $category['id']; ?>" class="btn-action edit" title="تعديل">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <button type="button" class="btn-action delete" title="حذف" onclick="deleteCategory(<?php echo $category['id']; ?>)">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>ملاحظة: لن يتم حذف المنتجات المرتبطة بهذا التصنيف، ولكن سيتم إزالة ارتباطها بالتصنيف.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إلغاء</button>
