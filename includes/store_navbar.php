...
// جلب بيانات المتجر للشعار إذا كان متاحًا
$store_logo = '';
...
<header class="store-dashboard-header">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a href="../customer/index.php" class="text-white text-decoration-none small">
                        <i class="bi bi-house-door"></i> الموقع الرئيسي
                    </a>
                </div>
                <div>
        ...
        <div class="container-fluid px-4">
            <a class="navbar-brand d-flex align-items-center" href="index.php">
                <?php if (!empty($store_logo)): ?>
                    <img src="../uploads/stores/<?php echo htmlspecialchars($store_logo); ?>" alt="شعار المتجر" class="me-2 rounded-circle" style="width: 32px; height: 32px; object-fit: cover;">
                <?php else: ?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="product_categories.php">
                            <i class="bi bi-tags me-1"></i> تصنيفات المنتجات
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="orders.php">
                            <i class="bi bi-cart me-1"></i> الطلبات
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="offers.php">
                            <i class="bi bi-tag me-1"></i> العروض
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../customer/store-page.php?id=<?php echo $_SESSION['store_id'] ?? ''; ?>" target="_blank">
                            <i class="bi bi-eye me-1"></i> عرض المتجر
                        </a>
                    </li>
                    <?php if (isset($_SESSION['store_id'])): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <?php if (!empty($store_logo)): ?>
                                    <img src="../uploads/stores/<?php echo htmlspecialchars($store_logo); ?>" alt="شعار المتجر" class="me-2 rounded-circle" style="width: 24px; height: 24px; object-fit: cover;">
                                <?php else: ?>
                                    <i class="bi bi-person-circle me-1"></i>
                                <?php endif; ?>
                                <span><?php echo htmlspecialchars($_SESSION['store_name'] ?? 'حسابي'); ?></span>
                            </a>
    ...
    <!-- شريط التنبيهات إذا كان هناك تنبيهات -->
...
<style>
    ...
    /* تحسين مظهر القائمة على الأجهزة المحمولة */
