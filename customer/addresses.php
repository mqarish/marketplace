<?php
/**
 * صفحة إدارة العناوين - إضافة وتعديل وحذف عناوين الشحن للعميل
 */
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    // التأكد من أن العنوان ينتمي للعميل الحالي
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($delete_stmt->execute()) {
            ...
            $error_message = "حدث خطأ أثناء حذف العنوان";
        }
    } else {
        $error_message = "العنوان غير موجود أو لا يمكنك حذفه";
    }
}
...
<head>
    ...
    <title>عناويني - السوق الإلكتروني</title>
...
<body>
    ...
    <div class="page-header text-center">
        <div class="container">
            <h1><i class="bi bi-geo-alt me-2"></i> عناويني</h1>
            <p class="lead">إدارة عناوين الشحن الخاصة بك</p>
        </div>
    </div>
    ...
    <div class="container py-4">
        ...
        <div class="row mb-4">
            <div class="col text-start">
                <button class="btn btn-add-address" data-bs-toggle="modal" data-bs-target="#addressModal">
                    <i class="bi bi-plus me-2"></i> إضافة عنوان جديد
                </button>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <?php if ($address['is_default']): ?>
                                    <div class="default-badge">
                                        <i class="bi bi-check-circle me-1"></i> العنوان الافتراضي
                                    </div>
                                <?php endif; ?>
        ...
        <?php else: ?>
            <div class="empty-addresses">
                <i class="bi bi-geo-alt"></i>
                <h3>لا توجد عناوين مسجلة</h3>
                <p class="text-muted">قم بإضافة عنوان جديد لتسهيل عملية الشراء</p>
                <button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#addressModal">
                    <i class="bi bi-plus-circle me-2"></i> إضافة عنوان
                </button>
            </div>
        <?php endif; ?>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addressForm" method="POST" action="">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="title" class="form-label">عنوان العنوان *</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="building" class="form-label">المبنى/الفيلا</label>
                                <input type="text" class="form-control" id="building" name="building">
                            </div>
                            <div class="col-md-6">
                                <label for="apartment" class="form-label">الشقة/الدور</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="3" 
                                      placeholder="أي تفاصيل إضافية تساعد في توصيل الطلب..."></textarea>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // تغيير عنوان النموذج
                modalTitle.textContent = 'تعديل العنوان';
            });
        });
        ...
        addressModal.addEventListener('hidden.bs.modal', function() {
            ...
            modalTitle.textContent = 'إضافة عنوان جديد';
        });
    });
    </script>
</body>
