<?php
/**
 * صفحة المنتجات الأعلى تقييماً - عرض المنتجات حسب التقييم بغض النظر عن المتجر
 */
...
<head>
    ...
    <meta name="description" content="المنتجات الأعلى تقييماً في السوق الإلكتروني">
    <title>المنتجات الأعلى تقييماً | السوق الإلكتروني</title>
...
<body>
    ...
    <div class="container py-5">
        <div class="row mb-4">
            <div class="col">
                <h1 class="section-title">المنتجات الأعلى تقييماً</h1>
                <p class="text-muted">استكشف أفضل المنتجات تقييماً في السوق بغض النظر عن المتجر</p>
            </div>
        </div>
        ...
        <?php else: ?>
            <div class="alert alert-info py-4 text-center">
                ...
                <h4 class="alert-heading">لا توجد منتجات مقيمة حالياً</h4>
                <p class="mb-0">لم يتم العثور على أي منتجات مقيمة. يمكنك تصفح المنتجات وتقييمها لتظهر هنا.</p>
            </div>
        <?php endif; ?>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addToCartButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // هنا يمكن إضافة وظيفة إضافة المنتج إلى سلة التسوق
