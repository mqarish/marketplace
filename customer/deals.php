<?php
/**
 * صفحة العروض والتخفيضات - عرض المنتجات التي عليها عروض وتخفيضات بغض النظر عن المتجر
 */
...
$products_sql = "SELECT p.*, 
                ...
                INNER JOIN offers o ON op.offer_id = o.id 
                    ...
                    AND o.end_date >= NOW()
                    AND o.status = 'active'
                INNER JOIN offer_store_products osp ON o.id = osp.offer_id AND p.store_id = osp.store_id
...
<head>
    ...
    <meta name="description" content="أفضل العروض والتخفيضات في السوق الإلكتروني">
    <title>العروض والتخفيضات | السوق الإلكتروني</title>
...
<body>
    ...
    <div class="container py-5">
        <div class="row mb-4">
            <div class="col">
                <h1 class="section-title">أفضل العروض والتخفيضات</h1>
                <p class="text-muted">استكشف أفضل العروض والتخفيضات المتاحة حالياً في السوق</p>
            </div>
        </div>
        ...
        <div class="filter-section mb-4">
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    <label for="categoryFilter" class="form-label">تصفية حسب التصنيف</label>
                ...
                <div class="col-md-6">
                    <label for="discountFilter" class="form-label">تصفية حسب نسبة الخصم</label>
                    <select class="form-select" id="discountFilter">
                        <option value="">جميع الخصومات</option>
                        <option value="50">خصم 50% أو أكثر</option>
                        <option value="30">خصم 30% أو أكثر</option>
                        <option value="20">خصم 20% أو أكثر</option>
                        <option value="10">خصم 10% أو أكثر</option>
                    </select>
                </div>
            </div>
        </div>
                                ...
                                <?php if ($product['days_remaining'] <= 3): ?>
                                    <div class="countdown-badge">
                                        ...
                                        <?php elseif ($product['days_remaining'] == 1): ?>
                                            ينتهي غداً!
                                        <?php else: ?>
                                            ينتهي خلال <?php echo $product['days_remaining']; ?> أيام
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="product-price mb-3">
                                    ...
                                    <div class="savings mt-1 small text-success">
                                        توفير: <?php echo number_format($product['price'] - $product['final_price'], 2); ?> ريال
                                    </div>
                                </div>
        ...
        <?php else: ?>
            <div class="alert alert-info py-4 text-center">
                ...
                <h4 class="alert-heading">لا توجد عروض متاحة حالياً</h4>
                <p class="mb-0">لم يتم العثور على أي منتجات بعروض نشطة. يرجى التحقق لاحقاً.</p>
            </div>
        <?php endif; ?>
    </div>
        ...
        function applyFilters() {
            ...
            if (visibleProducts.length === 0) {
                ...
                if (!document.getElementById('no-results-message')) {
                    ...
                    noResults.innerHTML = 'لا توجد منتجات تطابق معايير التصفية المحددة.';
