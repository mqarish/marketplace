...
<body>
  ...
  <p>This privacy policy applies to the شهبندر app (hereby referred to as "Application") for mobile devices that was created by Muath (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p><br><strong>Information Collection and Use</strong>
  ...
  <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p><br><strong>Third Party Access</strong>
  ...
  <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at muathye@gmail.com and they will respond in a reasonable time.</p><br><strong>Children</strong>
  ...
  <div><br>
    <p>The Application does not address anyone under the age of 13.
      ...
      personal information, please contact the Service Provider (muathye@gmail.com) so that
  ...
  <p>This privacy policy is effective as of 2025-07-11</p><br><strong>Your Consent</strong>
  ...
  <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at muathye@gmail.com.</p>
</body>
