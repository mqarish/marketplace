    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            if ($admin = $result->fetch_assoc()) {
                // التحقق من كلمة المرور باستخدام MD5
...
<head>
    ...
    <title>تسجيل دخول المسؤول - لوحة التحكم</title>
...
<body>
    <div class="login-container">
        ...
        <p class="login-subtitle">مرحباً بك في لوحة تحكم المسؤول</p>
        ...
        <form method="POST" action="">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="username" name="username" 
                       placeholder="اسم المستخدم" required value="<?php echo htmlspecialchars($username); ?>">
